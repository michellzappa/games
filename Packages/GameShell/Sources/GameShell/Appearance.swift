...
public final class Appearance {
    ...
    public enum AccessibilitySetting: Int, CaseIterable {
        ...
        public func resolved(using systemValue: Bool) -> Bool {
            switch self {
    ...
    public enum ColorSchemeSetting: Int, CaseIterable {
    ...
    public enum Theme: Int, CaseIterable {
        ...
        public func color(for accent: GameAccent) -> Color {
            switch (self, accent) {
        ...
        public func highlight(for accent: GameAccent) -> Color {
            switch (self, accent) {
        ...
        public var fourthPlayerColor: Color {
            switch self {
        ...
        /// The face of a card or a board tile. Dusk is the supporter-only
        /// finish: a warm paper-and-metal feel that changes no identity color
        /// and gives its owner no gameplay advantage.
        ...
        /// The dashed outline of an empty slot. Same hue as `border`, drawn
        /// stronger because nothing sits under it.
        public var slotBorder: Color {
            switch self {
            case .dusk: dynamicColor(
    ...
    public func playerColor(for slot: Int) -> Color {
        switch slot {
    ...
    public var successColor: Color { theme.successColor }
    public var errorColor: Color { theme.errorColor }
    ...
    public var gameBackground: Color {
